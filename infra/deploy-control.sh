...
$(grep -E '^((CLOUDFLARE|LEMONSQUEEZY|LS_VARIANT|CIC_ADMIN|CIC_ALERT|CIC_LEGAL|CIC_SUPPORT|CIC_REFUND|CIC_PAID|CIC_OWNER|MAIL|GOOGLE|APPLE|SHOWCASE|TURNSTILE)_|CIC_SIGNUP_TEST_SECRET=|CIC_HEARTBEAT_URL=|CIC_SAFE_BROWSING_KEY=)' .env)
